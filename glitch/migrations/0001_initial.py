# Generated by Django 5.0.4 on 2024-05-29 10:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('niveau', models.IntegerField(choices=[(1, 'Niveau 1'), (2, 'Niveau 2'), (3, 'Niveau 3'), (4, 'Niveau 4')], default=1)),
        ...
        migrations.AddField(
            model_name='cursusjaar',
            name='domein',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='glitch.domein'),
        ),
        migrations.CreateModel(
            name='Module',
            fields=[
                ...
                ('challenge', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='glitch.challenge')),
